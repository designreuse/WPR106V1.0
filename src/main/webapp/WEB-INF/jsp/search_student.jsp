...
<div style="display:none" id="div"><div class="searchpanel">
			        ...
			        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
							    ...
							    <c:forEach items="${studentregistrationform.studentregistration}" var="studentRegistration1" varStatus="status">
							    <option value="${studentRegistration1.org_name}">${studentRegistration1.org_name}</option>
							    </c:forEach>
							    </select></td>
							    ...
							    <select   id="e2"style="width:250px;" name="branch">
							     <option value="">Select None</option>
							    <c:forEach items="${studentregistrationform.studentregistration}" var="studentRegistration1" varStatus="status">
							    <option value="${studentRegistration1.branch}">${studentRegistration1.branch}</option>
							    </c:forEach>
							    </select></td>
							    ...
							    <select   id="e3"style="width:250px;" name="student_roll_no">
							     <option value="">Select None</option>
							    <c:forEach items="${studentregistrationform.studentregistration}" var="studentRegistration1" varStatus="status">
							    <option value="${studentRegistration1.student_roll_no}">${studentRegistration1.student_roll_no}</option>
							    </c:forEach>
							    </select></td>
							  ...
							  <tr>
							    ...
							    <select   id="e4"style="width:250px;" name="firstname">
							     <option value="">Select None</option>
							    <c:forEach items="${studentregistrationform.studentregistration}" var="studentRegistration1" varStatus="status">
							    <option value="${studentRegistration1.first_name}">${studentRegistration1.first_name}</option>
							    </c:forEach>
							    </select></td>
							    <td align="left" valign="middle" width="10%">&nbsp;Last Name<br/>
							    <select   id="e5"style="width:250px;" name="lastname">
							     <option value="">Select None</option>
							    <c:forEach items="${studentregistrationform.studentregistration}" var="studentRegistration1" varStatus="status">
							    <option value="${studentRegistration1.last_name}">${studentRegistration1.last_name}</option>
							    </c:forEach>
							    </select></td>
