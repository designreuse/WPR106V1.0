  ...
  <%-- 
     ...
     <script type="text/javascript">
        $(document).ready(function() {
            ...
            '<c:forEach items="${orgregistrationform.orgregistration}" var="orgRegistration">';
                cities2[i2]='<c:out value="${orgRegistration.city}"></c:out>';
                i2=i2+1;
            '</c:forEach>';
            ...
            '<c:forEach items="${orgregistrationform.orgregistration}" var="orgRegistration">';
                cities3[i3]='<c:out value="${orgRegistration.country}"></c:out>';
...
<form action="findorg" method="GET">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							  ...
							  <tr>
							    ...
							    <td align="right" valign="middle" width="10%" class="input_txtlabel">&nbsp;City&nbsp;</td>
							    <td align="left" valign="middle" width="10%"><input id="ms9" style="width:200px;" type="text"/></td>
                                 </tr><tr>							   
							    <td align="right" valign="middle" width="10%" class="input_txtlabel">&nbsp;Country&nbsp;</td>
