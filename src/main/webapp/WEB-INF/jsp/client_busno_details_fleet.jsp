      		...
      		<tr>
        		<td valign="top" align="left">
			        <div class="headings altheading"> 
			          <h2>Bus Details View <span style="margin:0 0 0 80%;"><a href="javascript:history.back();" class="submit_btn12" >Go Back</a> </span> </h2>
			        </div>
							...
							<tr class="title">
								<!-- <input type="checkbox" onclick="selectall(this.form)" value="" name="checkall"> -->					
					         	<td valign="top" align="left" width="10%">Date</td>
          						...
          						<td valign="top" align="left" width="10%">Duration</td>
