	...
	<input type="text" id="search" name="search" placeholder="Enter Text To Filter" class="light-table-filter" data-table="order-table" placeholder="Filter"/>
        				...
        				<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr class="title">
         						...
         						<td valign="top" align="left" width="18%"><span style="line-height:12px;font-weight:bold;"><br/>Organization Name</span></td>
					         	...
					         	<td valign="top" align="left" width="5%"><span style="line-height:12px;font-weight:bold;"><br/>&nbsp;Use<br/>&nbsp;Map</span></td>
          						<td valign="top" align="left" width="12%"><span style="line-height:12px;font-weight:bold;"><br/>&nbsp;PickUp <br/>&nbsp;Start/end</span></td>          						
          						<td valign="top" align="left" width="12%"><span style="line-height:12px;font-weight:bold;"><br/>&nbsp;Drop <br/>&nbsp;Start/end</span></td>
    	...
    	<div class="Panel_One_Inner">
				        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
        					...
        					<c:forEach items="${orgBusinessRuleForm.orgBusinessRules}" var="vieworgBusinessRules" varStatus="status">
        				       ...
        				       <td valign="top" align="left" style="overflow:hidden;"width="18%">${vieworgBusinessRules.org_name}</td>
					         	<td valign="top" align="left" style="overflow:hidden;"width="13%">${vieworgBusinessRules.branch}</td>
					         	<td valign="top" align="left" style="overflow:hidden;"width="5%">${vieworgBusinessRules.google_map_traffic}</td>
          						<td valign="top" align="left" style="overflow:hidden;"width="12%">${vieworgBusinessRules.pickup_start_time } &#47; ${vieworgBusinessRules.pickup_end_time }</td>          						
          						<td valign="top" align="left" style="overflow:hidden;"width="12%">${vieworgBusinessRules.drop_start_time } &#47; ${vieworgBusinessRules.drop_end_time }</td>
          						<td valign="top" align="left" style="overflow:hidden;"width="13%">${vieworgBusinessRules.kg_start_time } &#47; ${vieworgBusinessRules.kg_end_time }</td>
