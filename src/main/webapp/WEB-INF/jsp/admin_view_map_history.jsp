...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:20px;">
			                 ...
			                 <td align="right" valign="middle" width="10%">Branch:&nbsp;&nbsp;</td>
							   ...
							   <option value="">-- Select Vechicle --</option>
							    ...
							    <td align="center" valign="middle" width="8%"><input type="submit" class="submit_btn" value="Show" name="find"></td>
							 <td align="center" valign="middle" width="8%"><input type="reset" class="submit_btn" value="Cancel"></td>
							  </tr>
							</table>
