...
ddaccordion.init({
	...
	togglehtml: ["prefix", "<span style='align:right;color:#ffffff;'>&#9660; &nbsp;  &nbsp;</span>", "<span style='align:right;color:#ffffff;'>&#9650; &nbsp; &nbsp;</span>"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
